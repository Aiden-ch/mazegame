...
public class InventoryHandler implements Screen {
	...
	public static void initCards() {
		...
		Projectile crystalProj = new Fire(new Texture("projectiles/crystal.png"), 15, 8, 2, 380, 0.5);
		...
		Projectile thornProj = new Fire(new Texture("projectiles/thorn.png"), 10, 7, 3, 520, 0.8);
		...
		//starter ranged
		Projectile arcaneProj = new Fire(new Texture("projectiles/arcanebolt.png"), 17, 3, 1, 800, 0.2);
		...
		Projectile flame = new Fire(new Texture("effects/red.png"), 12, 1.5, 100, 180, 0);
		...
		Projectile frost = new Fire(new Texture("projectiles/frost.png"), 9, 3, 100, 180, 0);
		RangedItem frostCard = new RangedItem(frost, 0.1d, 50, 75, 0.03d, 250, 50.1);
