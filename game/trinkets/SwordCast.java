...
public class SwordCast extends Trinket {
	...
	RangedItem swordlaunch = new RangedItem(new Projectile(new Texture("projectiles/swordbolt.png"), 15d, 5d, 20, 0.3), 0.1d, 1, 0, 0.1d, 20, 0.1);
	RangedItem swordBlast = new RangedItem(new Projectile(new Texture("projectiles/swordbolt.png"), 15d, 5d, 20, 0.5), 0.1d, 3, 10, 0.5d, 20, 0.1);
